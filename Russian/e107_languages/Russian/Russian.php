...
define("CORE_LAN1", "Ошибка: Тема отсутствует.\\n\\nИзмените используемые темы в настройках (админки) или загрузите файлы для текущей темы на сервер.");


define("CORE_LAN4", "Обязательно, удалите install.php с вашего сервера");
define("CORE_LAN5", "иначе, существует потенциальный риск для безопасности вашего веб-сайта");
define("CORE_LAN6", "Защита от флуда, на этом сайте, активирована. Предупреждаем, что вы можете бы быть забанены.");
define("CORE_LAN7", "Ядро пытается восстановить настройки из автоматически созданной резервной копии.");
define("CORE_LAN8", "Ошибка параметров ядра");
define("CORE_LAN9", "Ядро не смогло восстановиться из резервной копии. Выполнение остановлено.");
define("CORE_LAN10", "Обнаружен поврежденный файл cookie - выход из системы.");

// Footer
define("CORE_LAN11", "Время загрузки:");
define("CORE_LAN12", "сек (");
define("CORE_LAN13", "%, из этого для запросовв)");
define("CORE_LAN14", "%2.3F процессор сек (%2.2f%% загрузка, %2.3f запуск). Время:");
...
define("LAN_RELATED", "Связанный");
define("LAN_CLOSE", "Закрыть");
define("LAN_EXPAND", "Раскрыть");

define("LAN_ENTER_USRNAME_EMAIL", "Введите ваше имя пользователя или email");
define("LAN_PWD_REQUIRED", "Требуется пароль");
define("LAN_SHOW", "Показать");
define("LAN_GENERATE", "Генерировать");
define("LAN_SUMMARY", "Cводка");
define("LAN_REQUIRED_BLANK", "Обязательные поля были оставлены пустыми.");
define("LAN_PLEASEWAIT", "Подождите");
